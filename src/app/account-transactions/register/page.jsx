...
const Register = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-gray-800 to-black relative">
      ...
      ></div>
      {/* Kayıt kutusu */}
      <div className="bg-black bg-opacity-60 backdrop-blur-sm border text-white border-red-500 p-8 rounded-lg shadow-xl max-w-sm w-full relative z-10">
        <h2 className="text-4xl font-extrabold mb-6 text-red-600">Kayıt Ol</h2>
        ...
        <form onSubmit={handleRegister}>
          <input
            type="text"
            className="bg-transparent border w-full p-3 mb-4 rounded focus:outline-none focus:ring-2 focus:ring-red-600 text-white"
          ...
          Zaten hesabın varmı?{" "}
          <Link href="/account-transactions/login" className="text-red-500 cursor-pointer hover:underline">
             Giriş yap
         </Link>
        </p>
        </form>
        ...
        <div className="mt-6 flex justify-around">
          <button
            ...
            className="bg-red-600 text-white p-3 rounded-full hover:bg-red-700 transition flex items-center justify-center"
